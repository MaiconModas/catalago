...
const numeroCelularCamiseta = "5533999525665"; // Número de WhatsApp para camisetas
const mensagemWhatsAppCamiseta = "Olá, vim do seu catálogo."; // Mensagem de WhatsApp para camisetas
const mostrarNumeroCelularCamiseta = true; // Defina como true ou false para mostrar ou esconder o número de celular
